...
#set_property ip_complexity "medium" [ipgui::get_canvasspec -of $IPINST]
    ...
    set tabgroup7 [ipgui::add_group $IPINST -parent $Page0 -name {APM Modes} -layout horizontal] 
        set C_LITE_ADDRESS_WIDTH [ipgui::add_param $IPINST -name C_LITE_ADDRESS_WIDTH -widget checkBox]
        set_property tooltip "AXI Lite interface address width" $C_LITE_ADDRESS_WIDTH
        set_property visible false [ipgui::get_guiparamspec -name C_LITE_ADDRESS_WIDTH -of $IPINST]
	...
	set C_S_AXI_ID_WIDTH [ipgui::add_param $IPINST -parent $tabgroup0 -name C_S_AXI_ID_WIDTH -widget comboBox]
     ...
     #CR#782642 {
     set C_S_AXI4_BASEADDR [ipgui::add_param $IPINST -parent $tabgroup0 -name C_S_AXI4_BASEADDR]
     set C_S_AXI4_HIGHADDR [ipgui::add_param $IPINST -parent $tabgroup0 -name C_S_AXI4_HIGHADDR]
     set_property visible false [ipgui::get_guiparamspec -name C_S_AXI4_BASEADDR -of $IPINST]
     set_property visible false [ipgui::get_guiparamspec -name C_S_AXI4_HIGHADDR -of $IPINST]
     #}
...
#	set_property display_name "TData Width" $C_FIFO_AXIS_TDATA_WIDTH
	set_property display_name "TID Width" $C_FIFO_AXIS_TID_WIDTH
       ...
       #set panel3 [ipgui::add_panel $IPINST -parent $Page3 -name panel3 -layout horizontal]
        set C_EN_AXI_DEBUG [ipgui::add_param $IPINST -parent $tabgroup5 -name C_EN_AXI_DEBUG -widget checkBox]
        set_property tooltip "Enabling captures the Read and Write Address info in Log" $C_EN_AXI_DEBUG 
        set C_EN_TRIGGER [ipgui::add_param $IPINST -parent $tabgroup5 -name C_EN_TRIGGER -widget checkBox]
        set_property tooltip "Enabling cross trigger mechanism" $C_EN_TRIGGER 
        #set_property enabled false [ipgui::get_guiparamspec C_EN_TRIGGER -of $IPINST]
        #set_property enabled false  ${PARAM_VALUE.C_EN_TRIGGER} 
	...
	ipgui::add_row $IPINST -parent $tabgroup5
        ...
        set C_EN_ALL_TRACE [ipgui::add_param $IPINST -parent $tabgroup5 -name C_EN_ALL_TRACE -widget checkBox]
        set_property tooltip "Enabling captures all the events data in Log provided their enablement in control register" $C_EN_ALL_TRACE 
...
##proc update_debug { param1 param2 assert } {
##    puts $param1
##    
##    set debug [get_property value ${PARAM_VALUE.$param1}]
##set val $assert
## if { $debug == 1 } {
## set_property value $val  ${PARAM_VALUE.$param2}
## set_property enabled false  ${PARAM_VALUE.$param} 
##
## }
##}
...
proc update_PARAM_VALUE.C_EN_LAST_WRITE_FLAG { PARAM_VALUE.C_EN_LAST_WRITE_FLAG PARAM_VALUE.C_EN_AXI_DEBUG PARAM_VALUE.C_EN_ALL_TRACE} {
#update_debug C_EN_AXI_DEBUG C_EN_LAST_WRITE_FLAG 0
set debug [get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG}]
set all_en [get_property value ${PARAM_VALUE.C_EN_ALL_TRACE}]
 if { $debug == 1 || $all_en == 1} {
 set_property value 1  ${PARAM_VALUE.C_EN_LAST_WRITE_FLAG}
 set_property enabled false  ${PARAM_VALUE.C_EN_LAST_WRITE_FLAG} 
 } else {
 set_property value [get_property default_value ${PARAM_VALUE.C_EN_LAST_WRITE_FLAG}]  ${PARAM_VALUE.C_EN_LAST_WRITE_FLAG}
 set_property enabled true  ${PARAM_VALUE.C_EN_LAST_WRITE_FLAG} 
 }
}

proc update_PARAM_VALUE.C_EN_WR_ADD_FLAG { PARAM_VALUE.C_EN_WR_ADD_FLAG PARAM_VALUE.C_EN_AXI_DEBUG PARAM_VALUE.C_EN_ALL_TRACE} {
set debug [get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG}]
 set all_en [get_property value ${PARAM_VALUE.C_EN_ALL_TRACE}]
if { $debug == 0 && $all_en == 1} {
 set_property value 1  ${PARAM_VALUE.C_EN_WR_ADD_FLAG}
 set_property enabled false  ${PARAM_VALUE.C_EN_WR_ADD_FLAG} 
 } elseif { $debug == 1 && $all_en == 0} {
 set_property value 0  ${PARAM_VALUE.C_EN_WR_ADD_FLAG}
 set_property enabled false  ${PARAM_VALUE.C_EN_WR_ADD_FLAG} 
 } else {
 set_property value [get_property default_value ${PARAM_VALUE.C_EN_WR_ADD_FLAG}]  ${PARAM_VALUE.C_EN_WR_ADD_FLAG}
 set_property enabled true  ${PARAM_VALUE.C_EN_WR_ADD_FLAG} 
 }
}

proc update_PARAM_VALUE.C_EN_EXT_EVENTS_FLAG { PARAM_VALUE.C_EN_EXT_EVENTS_FLAG PARAM_VALUE.C_EN_AXI_DEBUG PARAM_VALUE.C_EN_ALL_TRACE} {
#update_debug C_EN_AXI_DEBUG C_EN_LAST_WRITE_FLAG 0
set debug [get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG}]
set all_en [get_property value ${PARAM_VALUE.C_EN_ALL_TRACE}]
 if { $debug == 0 && $all_en == 1} {
 set_property value 1  ${PARAM_VALUE.C_EN_EXT_EVENTS_FLAG}
 set_property enabled false  ${PARAM_VALUE.C_EN_EXT_EVENTS_FLAG} 
 } elseif { $debug == 1 && $all_en == 0} {
 set_property value 0  ${PARAM_VALUE.C_EN_EXT_EVENTS_FLAG}
 set_property enabled false  ${PARAM_VALUE.C_EN_EXT_EVENTS_FLAG} 
 } else {
 set_property value [get_property default_value ${PARAM_VALUE.C_EN_EXT_EVENTS_FLAG}]  ${PARAM_VALUE.C_EN_EXT_EVENTS_FLAG}
 set_property enabled true  ${PARAM_VALUE.C_EN_EXT_EVENTS_FLAG} 
 }
}


proc update_PARAM_VALUE.C_EN_RESPONSE_FLAG { PARAM_VALUE.C_EN_RESPONSE_FLAG PARAM_VALUE.C_EN_AXI_DEBUG PARAM_VALUE.C_EN_ALL_TRACE} {
set debug [get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG}]
 set all_en [get_property value ${PARAM_VALUE.C_EN_ALL_TRACE}]
 if { $debug == 0 && $all_en == 1} {
 set_property value 1  ${PARAM_VALUE.C_EN_RESPONSE_FLAG}
 set_property enabled false  ${PARAM_VALUE.C_EN_RESPONSE_FLAG} 
 } elseif { $debug == 1 && $all_en == 0 } {
 set_property value 0  ${PARAM_VALUE.C_EN_RESPONSE_FLAG}
 set_property enabled false  ${PARAM_VALUE.C_EN_RESPONSE_FLAG} 
 } else {
 set_property value [get_property default_value ${PARAM_VALUE.C_EN_RESPONSE_FLAG}]  ${PARAM_VALUE.C_EN_RESPONSE_FLAG}
 set_property enabled true  ${PARAM_VALUE.C_EN_RESPONSE_FLAG} 
 }
}

proc update_PARAM_VALUE.C_SHOW_AXI_IDS { PARAM_VALUE.C_SHOW_AXI_IDS PARAM_VALUE.C_EN_AXI_DEBUG PARAM_VALUE.C_EN_ALL_TRACE} {
set debug [get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG}]
 set all_en [get_property value ${PARAM_VALUE.C_EN_ALL_TRACE}]
 if { $debug == 0 && $all_en == 1} {
 set_property value 1  ${PARAM_VALUE.C_SHOW_AXI_IDS}
 set_property enabled false  ${PARAM_VALUE.C_SHOW_AXI_IDS} 
 } elseif { $debug == 1 && $all_en == 0} {
 set_property value 0  ${PARAM_VALUE.C_SHOW_AXI_IDS}
 set_property enabled false  ${PARAM_VALUE.C_SHOW_AXI_IDS} 
 } else {
 set_property value [get_property default_value ${PARAM_VALUE.C_SHOW_AXI_IDS}]  ${PARAM_VALUE.C_SHOW_AXI_IDS}
 set_property enabled true  ${PARAM_VALUE.C_SHOW_AXI_IDS} 
 }


}

##proc update_PARAM_VALUE.C_EN_RD_ADD_FLAG { PARAM_VALUE.C_EN_RD_ADD_FLAG PARAM_VALUE.C_EN_AXI_DEBUG PARAM_VALUE.C_EN_ALL_TRACE} {
##set debug [get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG}]
## set all_en [get_property value ${PARAM_VALUE.C_EN_ALL_TRACE}]
## if { $debug == 1 || $all_en == 1} {
## set_property value 1  ${PARAM_VALUE.C_EN_RD_ADD_FLAG}
## set_property enabled false  ${PARAM_VALUE.C_EN_RD_ADD_FLAG} 
## } else {
## set_property value [get_property default_value ${PARAM_VALUE.C_EN_RD_ADD_FLAG}]  ${PARAM_VALUE.C_EN_RD_ADD_FLAG}
## set_property enabled true  ${PARAM_VALUE.C_EN_RD_ADD_FLAG} 
## }
##
##
##}

proc update_PARAM_VALUE.C_EN_FIRST_READ_FLAG { PARAM_VALUE.C_EN_FIRST_READ_FLAG PARAM_VALUE.C_EN_AXI_DEBUG PARAM_VALUE.C_EN_ALL_TRACE} {
set debug [get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG}]
 set all_en [get_property value ${PARAM_VALUE.C_EN_ALL_TRACE}]
 if { $debug == 1 || $all_en == 1} {
 set_property value 1  ${PARAM_VALUE.C_EN_FIRST_READ_FLAG}
 set_property enabled false  ${PARAM_VALUE.C_EN_FIRST_READ_FLAG} 
 } else {
 set_property value [get_property default_value ${PARAM_VALUE.C_EN_FIRST_READ_FLAG}]  ${PARAM_VALUE.C_EN_FIRST_READ_FLAG}
 set_property enabled true  ${PARAM_VALUE.C_EN_FIRST_READ_FLAG} 
 }
}

proc update_PARAM_VALUE.C_EN_LAST_READ_FLAG { PARAM_VALUE.C_EN_LAST_READ_FLAG PARAM_VALUE.C_EN_AXI_DEBUG PARAM_VALUE.C_EN_ALL_TRACE} {
set debug [get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG}]
 set all_en [get_property value ${PARAM_VALUE.C_EN_ALL_TRACE}]
 if { $debug == 1 || $all_en == 1} {
 set_property value 1  ${PARAM_VALUE.C_EN_LAST_READ_FLAG}
 set_property enabled false  ${PARAM_VALUE.C_EN_LAST_READ_FLAG} 
 } else {
 set_property value [get_property default_value ${PARAM_VALUE.C_EN_LAST_READ_FLAG}]  ${PARAM_VALUE.C_EN_LAST_READ_FLAG}
 set_property enabled true  ${PARAM_VALUE.C_EN_LAST_READ_FLAG} 
 }
}

proc update_PARAM_VALUE.C_EN_SW_REG_WR_FLAG { PARAM_VALUE.C_EN_SW_REG_WR_FLAG PARAM_VALUE.C_EN_AXI_DEBUG PARAM_VALUE.C_EN_ALL_TRACE} {
set debug [get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG}]
set all_en [get_property value ${PARAM_VALUE.C_EN_ALL_TRACE}]
 if { $debug == 0 && $all_en == 1} {
 set_property value 1  ${PARAM_VALUE.C_EN_SW_REG_WR_FLAG}
 set_property enabled false  ${PARAM_VALUE.C_EN_SW_REG_WR_FLAG} 
 } elseif { $debug == 1 && $all_en == 0} {
 set_property value 0  ${PARAM_VALUE.C_EN_SW_REG_WR_FLAG}
 set_property enabled false  ${PARAM_VALUE.C_EN_SW_REG_WR_FLAG} 
 } else {
 set_property value [get_property default_value ${PARAM_VALUE.C_EN_SW_REG_WR_FLAG}]  ${PARAM_VALUE.C_EN_SW_REG_WR_FLAG}
 set_property enabled true  ${PARAM_VALUE.C_EN_SW_REG_WR_FLAG} 
 }
}

proc update_PARAM_VALUE.C_EN_ALL_TRACE { PARAM_VALUE.C_EN_ALL_TRACE PARAM_VALUE.C_EN_AXI_DEBUG } {
set debug [get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG}]
if { $debug == 1} {
 set_property value 0  ${PARAM_VALUE.C_EN_ALL_TRACE}
 set_property enabled false  ${PARAM_VALUE.C_EN_ALL_TRACE} 
 } else {
 set_property value [get_property default_value ${PARAM_VALUE.C_EN_ALL_TRACE}]  ${PARAM_VALUE.C_EN_ALL_TRACE}
 set_property enabled true  ${PARAM_VALUE.C_EN_ALL_TRACE} 
 }
...
if { $debug == 0 && $all_en == 1} {
 ...
 set_property value 0  ${PARAM_VALUE.C_EN_RD_ADD_FLAG}
 set_property enabled false  ${PARAM_VALUE.C_EN_RD_ADD_FLAG} 
 } else {
 set_property value [get_property default_value ${PARAM_VALUE.C_EN_RD_ADD_FLAG}]  ${PARAM_VALUE.C_EN_RD_ADD_FLAG}
 set_property enabled true  ${PARAM_VALUE.C_EN_RD_ADD_FLAG} 
...
proc update_PARAM_VALUE.C_EN_FIRST_WRITE_FLAG { PARAM_VALUE.C_EN_FIRST_WRITE_FLAG PARAM_VALUE.C_EN_AXI_DEBUG PARAM_VALUE.C_EN_ALL_TRACE} {
 set debug [get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG}]
 set all_en [get_property value ${PARAM_VALUE.C_EN_ALL_TRACE}]
 if { $debug == 1 || $all_en == 1} {
 set_property value 1  ${PARAM_VALUE.C_EN_FIRST_WRITE_FLAG}
 set_property enabled false  ${PARAM_VALUE.C_EN_FIRST_WRITE_FLAG} 
 }  else {
 set_property value [get_property default_value ${PARAM_VALUE.C_EN_FIRST_WRITE_FLAG}]  ${PARAM_VALUE.C_EN_FIRST_WRITE_FLAG}
 set_property enabled true  ${PARAM_VALUE.C_EN_FIRST_WRITE_FLAG} 
 }


}

proc update_PARAM_VALUE.C_EN_TRIGGER { PARAM_VALUE.C_EN_TRIGGER PARAM_VALUE.C_EN_AXI_DEBUG } {
set debug [get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG}]
 if { $debug == 1 } {
 set_property value 1  ${PARAM_VALUE.C_EN_TRIGGER}
 #set_property enabled false  ${PARAM_VALUE.C_EN_TRIGGER} 
 } else {
 set_property value [get_property default_value ${PARAM_VALUE.C_EN_TRIGGER}]  ${PARAM_VALUE.C_EN_TRIGGER}
 #set_property enabled false  ${PARAM_VALUE.C_EN_TRIGGER} 
 }
}

proc update_PARAM_VALUE.C_SHOW_AXI_LEN { PARAM_VALUE.C_SHOW_AXI_LEN PARAM_VALUE.C_EN_AXI_DEBUG PARAM_VALUE.C_EN_ALL_TRACE} {
set debug [get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG}]
 set all_en [get_property value ${PARAM_VALUE.C_EN_ALL_TRACE}]
 if { $debug == 1 || $all_en == 1} {
 set_property value 1  ${PARAM_VALUE.C_SHOW_AXI_LEN}
 set_property enabled false  ${PARAM_VALUE.C_SHOW_AXI_LEN} 
 } else {
 set_property value [get_property default_value ${PARAM_VALUE.C_SHOW_AXI_LEN}]  ${PARAM_VALUE.C_SHOW_AXI_LEN}
 set_property enabled true  ${PARAM_VALUE.C_SHOW_AXI_LEN} 
 }
}
...
proc update_PARAM_VALUE.C_NUM_MONITOR_SLOTS { PARAM_VALUE.C_NUM_MONITOR_SLOTS PARAM_VALUE.C_EN_AXI_DEBUG PARAM_VALUE.C_SLOT_0_AXI_ADDR_WIDTH PARAM_VALUE.C_SLOT_1_AXI_ADDR_WIDTH PARAM_VALUE.C_SLOT_2_AXI_ADDR_WIDTH PARAM_VALUE.C_SLOT_3_AXI_ADDR_WIDTH PARAM_VALUE.C_SLOT_4_AXI_ADDR_WIDTH PARAM_VALUE.C_SLOT_5_AXI_ADDR_WIDTH PARAM_VALUE.C_SLOT_6_AXI_ADDR_WIDTH} {

set axi_debug [get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG}] 
set address_wid [get_property value ${PARAM_VALUE.C_SLOT_0_AXI_ADDR_WIDTH}]
set address_wid1 [get_property value ${PARAM_VALUE.C_SLOT_1_AXI_ADDR_WIDTH}]
set address_wid2 [get_property value ${PARAM_VALUE.C_SLOT_2_AXI_ADDR_WIDTH}]
set address_wid3 [get_property value ${PARAM_VALUE.C_SLOT_3_AXI_ADDR_WIDTH}]
##set num_slots [ipgui::get_paramspec C_NUM_MONITOR_SLOTS -of $ipview]
#puts "AXI DEBUG $axi_debug andd Address width $address_wid \n"
if { $axi_debug == 1 && ( $address_wid >32 || $address_wid1 >32 || $address_wid2 >32 || $address_wid3 >32) } {
#puts "32 > AXI DEBUG $axi_debug andd Address width $address_wid \n"
  
    set_property range 1,2,3,4 ${PARAM_VALUE.C_NUM_MONITOR_SLOTS}
} elseif { $axi_debug == 1 && ( $address_wid == 32  || $address_wid1 == 32 || $address_wid2 == 32 || $address_wid3 == 32) } {
 
#puts "32 == AXI DEBUG $axi_debug andd Address width $address_wid \n"
    set_property range 1,2,3,4,5,6 ${PARAM_VALUE.C_NUM_MONITOR_SLOTS} 
} else {
#puts " None AXI DEBUG $axi_debug andd Address width $address_wid \n"
  set_property range 1,2,3,4,5,6,7,8 ${PARAM_VALUE.C_NUM_MONITOR_SLOTS}
}
	# Procedure called to validate C_EN_AXI_DEBUG

}

proc validate_PARAM_VALUE.C_EN_AXI_DEBUG { PARAM_VALUE.C_EN_AXI_DEBUG} {
...
##proc validate_PARAM_VALUE.C_EN_TRIGGER { PARAM_VALUE.C_EN_TRIGGER PARAM_VALUE.C_EN_AXI_DEBUG } {
##        set axi_debug [ get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG} ]
##        set trig [ get_property value ${PARAM_VALUE.C_EN_TRIGGER} ]
##	if {$axi_debug == $trig} {
##	   return true
##	} else {
##	   set_property errmsg "Trigger feature and axi debug feature are dependent.Both should be asserted or de-asserted"  ${PARAM_VALUE.C_EN_TRIGGER} 
##  	   return false
##   } 
##	# Procedure called to validate C_EN_TRIGGER
##
##}
...
proc update_MODELPARAM_VALUE.C_FIFO_AXIS_TDATA_WIDTH {MODELPARAM_VALUE.C_FIFO_AXIS_TDATA_WIDTH   
  PARAM_VALUE.C_NUM_MONITOR_SLOTS PARAM_VALUE.C_SHOW_AXIS_TDEST  
  PARAM_VALUE.C_SHOW_AXIS_TID PARAM_VALUE.C_SHOW_AXIS_TUSER  
  PARAM_VALUE.C_SHOW_AXI_IDS PARAM_VALUE.C_SHOW_AXI_LEN  
  PARAM_VALUE.C_SLOT_0_AXIS_TDEST_WIDTH PARAM_VALUE.C_SLOT_0_AXIS_TID_WIDTH  
  PARAM_VALUE.C_SLOT_0_AXIS_TUSER_WIDTH PARAM_VALUE.C_SLOT_0_AXI_ID_WIDTH  
  PARAM_VALUE.C_SLOT_0_AXI_PROTOCOL PARAM_VALUE.C_SLOT_1_AXIS_TDEST_WIDTH  
  PARAM_VALUE.C_SLOT_1_AXIS_TID_WIDTH PARAM_VALUE.C_SLOT_1_AXIS_TUSER_WIDTH  
  PARAM_VALUE.C_SLOT_1_AXI_ID_WIDTH PARAM_VALUE.C_SLOT_1_AXI_PROTOCOL  
  PARAM_VALUE.C_SLOT_2_AXIS_TDEST_WIDTH PARAM_VALUE.C_SLOT_2_AXIS_TID_WIDTH  
  PARAM_VALUE.C_SLOT_2_AXIS_TUSER_WIDTH PARAM_VALUE.C_SLOT_2_AXI_ID_WIDTH  
  PARAM_VALUE.C_SLOT_2_AXI_PROTOCOL PARAM_VALUE.C_SLOT_3_AXIS_TDEST_WIDTH  
  PARAM_VALUE.C_SLOT_3_AXIS_TID_WIDTH PARAM_VALUE.C_SLOT_3_AXIS_TUSER_WIDTH  
  PARAM_VALUE.C_SLOT_3_AXI_ID_WIDTH PARAM_VALUE.C_SLOT_3_AXI_PROTOCOL  
  PARAM_VALUE.C_SLOT_4_AXIS_TDEST_WIDTH PARAM_VALUE.C_SLOT_4_AXIS_TID_WIDTH  
  PARAM_VALUE.C_SLOT_4_AXIS_TUSER_WIDTH PARAM_VALUE.C_SLOT_4_AXI_ID_WIDTH  
  PARAM_VALUE.C_SLOT_4_AXI_PROTOCOL PARAM_VALUE.C_SLOT_5_AXIS_TDEST_WIDTH  
  PARAM_VALUE.C_SLOT_5_AXIS_TID_WIDTH PARAM_VALUE.C_SLOT_5_AXIS_TUSER_WIDTH  
  PARAM_VALUE.C_SLOT_5_AXI_ID_WIDTH PARAM_VALUE.C_SLOT_5_AXI_PROTOCOL  
  PARAM_VALUE.C_SLOT_6_AXIS_TDEST_WIDTH PARAM_VALUE.C_SLOT_6_AXIS_TID_WIDTH  
  PARAM_VALUE.C_SLOT_6_AXIS_TUSER_WIDTH PARAM_VALUE.C_SLOT_6_AXI_ID_WIDTH  
  PARAM_VALUE.C_SLOT_6_AXI_PROTOCOL PARAM_VALUE.C_SLOT_7_AXIS_TDEST_WIDTH  
  PARAM_VALUE.C_SLOT_7_AXIS_TID_WIDTH PARAM_VALUE.C_SLOT_7_AXIS_TUSER_WIDTH  
  PARAM_VALUE.C_SLOT_7_AXI_ID_WIDTH PARAM_VALUE.C_SLOT_7_AXI_PROTOCOL
  PARAM_VALUE.C_EN_AXI_DEBUG
  PARAM_VALUE.C_EN_TRIGGER
...
proc update_MODELPARAM_VALUE.C_EN_AXI_DEBUG { MODELPARAM_VALUE.C_EN_AXI_DEBUG PARAM_VALUE.C_EN_AXI_DEBUG} {

	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value

	set_property value [get_property value  ${PARAM_VALUE.C_EN_AXI_DEBUG} ]  ${MODELPARAM_VALUE.C_EN_AXI_DEBUG} 

	return true

}

proc update_MODELPARAM_VALUE.C_EN_TRIGGER { MODELPARAM_VALUE.C_EN_TRIGGER PARAM_VALUE.C_EN_TRIGGER} {

	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value

	set_property value [get_property value  ${PARAM_VALUE.C_EN_TRIGGER} ]  ${MODELPARAM_VALUE.C_EN_TRIGGER} 
...
proc update_MODELPARAM_VALUE.C_METRICS_SAMPLE_COUNT_WIDTH { MODELPARAM_VALUE.C_METRICS_SAMPLE_COUNT_WIDTH} {
...
#CR#782642 {
proc update_MODELPARAM_VALUE.C_S_AXI4_BASEADDR { MODELPARAM_VALUE.C_S_AXI4_BASEADDR PARAM_VALUE.C_S_AXI4_BASEADDR} {
...
proc update_MODELPARAM_VALUE.C_S_AXI4_HIGHADDR { MODELPARAM_VALUE.C_S_AXI4_HIGHADDR PARAM_VALUE.C_S_AXI4_HIGHADDR} {

	# Procedure called to set VHDL generic/Verilog parameter value(s) HIGHd on TCL parameter value
...
##proc update_MODELPARAM_VALUE.C_S_AXI_PROTOCOL { MODELPARAM_VALUE.C_S_AXI_PROTOCOL} {
##
##	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
##
...
##proc update_MODELPARAM_VALUE.C_METRIC_COUNT_WIDTH { MODELPARAM_VALUE.C_METRIC_COUNT_WIDTH} {
##
##	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
##
...
proc update_MODELPARAM_VALUE.C_LITE_ADDRESS_WIDTH { MODELPARAM_VALUE.C_LITE_ADDRESS_WIDTH PARAM_VALUE.C_LITE_ADDRESS_WIDTH} {

	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value

	set_property value [get_property value  ${PARAM_VALUE.C_LITE_ADDRESS_WIDTH} ]  ${MODELPARAM_VALUE.C_LITE_ADDRESS_WIDTH} 
...
##	proc update_PARAM_VALUE.C_EXT_EVENT<<n>>_FIFO_ENABLE {PARAM_VALUE.C_EXT_EVENT<<n>>_FIFO_ENABLE PARAM_VALUE.C_ENABLE_TRACE PARAM_VALUE.C_ENABLE_PROFILE } {
##		#${PARAM_VALUE.C_EXT_EVENT<<n>>_FIFO_ENABLE}
##		set  en_trace [ get_property value ${PARAM_VALUE.C_ENABLE_TRACE} ]
##		set  en_profile [ get_property value ${PARAM_VALUE.C_ENABLE_PROFILE} ] 
##		if {$en_trace ==1} {
##		set_property value 1  ${PARAM_VALUE.C_EXT_EVENT<<n>>_FIFO_ENABLE}
##                } elseif {$en_profile == 1} {
##		set_property value 0  ${PARAM_VALUE.C_EXT_EVENT<<n>>_FIFO_ENABLE}
##                } 
##
##	}
############
proc update_PARAM_VALUE.C_SLOT_<<n>>_AXI_PROTOCOL {PARAM_VALUE.C_SLOT_<<n>>_AXI_PROTOCOL PARAM_VALUE.C_ENABLE_TRACE PARAM_VALUE.C_ENABLE_PROFILE PARAM_VALUE.C_EN_AXI_DEBUG } {
		set  en_trace [ get_property value ${PARAM_VALUE.C_ENABLE_TRACE} ]
		set  en_profile [ get_property value ${PARAM_VALUE.C_ENABLE_PROFILE} ]
		set  en_debug [ get_property value ${PARAM_VALUE.C_EN_AXI_DEBUG} ]
		if {$en_profile ==1 || $en_trace ==1 || $en_debug ==1} {
           		set_property range "AXI4,AXI3,AXI4LITE"   ${PARAM_VALUE.C_SLOT_<<n>>_AXI_PROTOCOL} 
        	} else {
           		set_property range "AXI4,AXI3,AXI4S,AXI4LITE"   ${PARAM_VALUE.C_SLOT_<<n>>_AXI_PROTOCOL} 
         }
}

proc update_MODELPARAM_VALUE.C_SLOT_<<n>>_AXI_AWLEN { MODELPARAM_VALUE.C_SLOT_<<n>>_AXI_AWLEN PARAM_VALUE.C_SLOT_<<n>>_AXI_PROTOCOL} {

	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
        set slot_protocol [ get_property value ${PARAM_VALUE.C_SLOT_<<n>>_AXI_PROTOCOL} ]
        if { $slot_protocol == "AXI3" } {
          set slot_wlen_hdl 3
        } else {
          set slot_wlen_hdl 7
        }
        set_property value $slot_wlen_hdl  ${MODELPARAM_VALUE.C_SLOT_<<n>>_AXI_AWLEN} 

	return true

}
proc update_MODELPARAM_VALUE.C_SLOT_<<n>>_AXI_LOCK { MODELPARAM_VALUE.C_SLOT_<<n>>_AXI_LOCK PARAM_VALUE.C_SLOT_<<n>>_AXI_PROTOCOL} {
	...
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
        ...
        set_property value $slot_wlen_hdl  ${MODELPARAM_VALUE.C_SLOT_<<n>>_AXI_LOCK} 
...
for {set i 0} {$i<8} {incr i} { 
            ...
            set PR [regsub -all <<n>> $PROC_set $i ]
	    eval $PR
}

proc update_MODELPARAM_VALUE.C_EN_ALL_TRACE { MODELPARAM_VALUE.C_EN_ALL_TRACE PARAM_VALUE.C_EN_ALL_TRACE} {

	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
        set en_all_trace_1 [ get_property value ${PARAM_VALUE.C_EN_ALL_TRACE} ]
        set en_all_trace 1
        set_property value $en_all_trace  ${MODELPARAM_VALUE.C_EN_ALL_TRACE} 
...
proc update_PARAM_VALUE.C_SLOT_0_AXI_ID_WIDTH {PARAM_VALUE.C_SLOT_0_AXI_PROTOCOL PARAM_VALUE.C_SLOT_0_AXI_ID_WIDTH} {
	set val [get_property value ${PARAM_VALUE.C_SLOT_0_AXI_PROTOCOL}]
		if {$val == "AXI4LITE" } {
                  ...
                  set_property range 0,32 ${PARAM_VALUE.C_SLOT_0_AXI_ID_WIDTH}
                }
}
...
proc update_PARAM_VALUE.C_SLOT_1_AXI_ID_WIDTH {PARAM_VALUE.C_SLOT_1_AXI_PROTOCOL PARAM_VALUE.C_SLOT_1_AXI_ID_WIDTH} {
	set val [get_property value ${PARAM_VALUE.C_SLOT_1_AXI_PROTOCOL}]
		if {$val == "AXI4LITE" } {
                  ...
                  set_property range 0,32 ${PARAM_VALUE.C_SLOT_1_AXI_ID_WIDTH}
...
proc update_PARAM_VALUE.C_SLOT_2_AXI_ID_WIDTH {PARAM_VALUE.C_SLOT_2_AXI_PROTOCOL PARAM_VALUE.C_SLOT_2_AXI_ID_WIDTH} {
	set val [get_property value ${PARAM_VALUE.C_SLOT_2_AXI_PROTOCOL}]
		if {$val == "AXI4LITE" } {
                  ...
                  set_property range 0,32 ${PARAM_VALUE.C_SLOT_2_AXI_ID_WIDTH}
...
proc update_PARAM_VALUE.C_SLOT_3_AXI_ID_WIDTH {PARAM_VALUE.C_SLOT_3_AXI_PROTOCOL PARAM_VALUE.C_SLOT_3_AXI_ID_WIDTH} {
	set val [get_property value ${PARAM_VALUE.C_SLOT_3_AXI_PROTOCOL}]
		if {$val == "AXI4LITE" } {
                  ...
                  set_property range 0,32 ${PARAM_VALUE.C_SLOT_3_AXI_ID_WIDTH}
...
proc update_PARAM_VALUE.C_SLOT_4_AXI_ID_WIDTH {PARAM_VALUE.C_SLOT_4_AXI_PROTOCOL PARAM_VALUE.C_SLOT_4_AXI_ID_WIDTH} {
	set val [get_property value ${PARAM_VALUE.C_SLOT_4_AXI_PROTOCOL}]
		if {$val == "AXI4LITE" } {
                  ...
                  set_property range 0,32 ${PARAM_VALUE.C_SLOT_4_AXI_ID_WIDTH}
...
proc update_PARAM_VALUE.C_SLOT_5_AXI_ID_WIDTH {PARAM_VALUE.C_SLOT_5_AXI_PROTOCOL PARAM_VALUE.C_SLOT_5_AXI_ID_WIDTH} {
	set val [get_property value ${PARAM_VALUE.C_SLOT_5_AXI_PROTOCOL}]
		if {$val == "AXI4LITE" } {
                  ...
                  set_property range 0,32 ${PARAM_VALUE.C_SLOT_5_AXI_ID_WIDTH}
...
proc update_PARAM_VALUE.C_SLOT_6_AXI_ID_WIDTH {PARAM_VALUE.C_SLOT_6_AXI_PROTOCOL PARAM_VALUE.C_SLOT_6_AXI_ID_WIDTH} {
	set val [get_property value ${PARAM_VALUE.C_SLOT_6_AXI_PROTOCOL}]
		if {$val == "AXI4LITE" } {
                  ...
                  set_property range 0,32 ${PARAM_VALUE.C_SLOT_6_AXI_ID_WIDTH}
...
proc update_PARAM_VALUE.C_SLOT_7_AXI_ID_WIDTH {PARAM_VALUE.C_SLOT_7_AXI_PROTOCOL PARAM_VALUE.C_SLOT_7_AXI_ID_WIDTH} {
	set val [get_property value ${PARAM_VALUE.C_SLOT_7_AXI_PROTOCOL}]
		if {$val == "AXI4LITE" } {
                  ...
                  set_property range 0,32 ${PARAM_VALUE.C_SLOT_7_AXI_ID_WIDTH}
...
proc update_gui_for_PARAM_VALUE.C_ENABLE_EVENT_LOG {IPINST PARAM_VALUE.C_ENABLE_EVENT_LOG PARAM_VALUE.C_ENABLE_TRACE} {
	  ...
	  set en_trace [ get_property value ${PARAM_VALUE.C_ENABLE_TRACE} ]
		...
		set_property visible false [ipgui::get_guiparamspec -name C_EN_ALL_TRACE -of $IPINST]
    } else {
...
proc update_gui_for_PARAM_VALUE.C_S_AXI4_BASEADDR {IPINST PARAM_VALUE.C_S_AXI4_BASEADDR} {

	return true
}

proc update_gui_for_PARAM_VALUE.C_S_AXI4_HIGHADDR {IPINST PARAM_VALUE.C_S_AXI4_HIGHADDR} {
...
proc validate_BUSIFPARAM_VALUE.CORE_ACLK.FREQ_HZ { BUSIFPARAM_VALUE.CORE_ACLK.FREQ_HZ BUSIFPARAM_VALUE.SLOT0_AXIS_CLK.FREQ_HZ BUSIFPARAM_VALUE.SLOT1_AXIS_CLK.FREQ_HZ BUSIFPARAM_VALUE.SLOT2_AXIS_CLK.FREQ_HZ BUSIFPARAM_VALUE.SLOT3_AXIS_CLK.FREQ_HZ BUSIFPARAM_VALUE.SLOT4_AXIS_CLK.FREQ_HZ BUSIFPARAM_VALUE.SLOT5_AXIS_CLK.FREQ_HZ BUSIFPARAM_VALUE.SLOT6_AXIS_CLK.FREQ_HZ BUSIFPARAM_VALUE.SLOT7_AXIS_CLK.FREQ_HZ BUSIFPARAM_VALUE.slot0_axi_clk.FREQ_HZ BUSIFPARAM_VALUE.slot1_axi_clk.FREQ_HZ BUSIFPARAM_VALUE.slot2_axi_clk.FREQ_HZ BUSIFPARAM_VALUE.slot3_axi_clk.FREQ_HZ BUSIFPARAM_VALUE.slot4_axi_clk.FREQ_HZ BUSIFPARAM_VALUE.slot5_axi_clk.FREQ_HZ BUSIFPARAM_VALUE.slot6_axi_clk.FREQ_HZ BUSIFPARAM_VALUE.slot7_axi_clk.FREQ_HZ BUSIFPARAM_VALUE.S_AXI_OFFLD_ACLK.FREQ_HZ BUSIFPARAM_VALUE.M_AXIS_ACLK.FREQ_HZ BUSIFPARAM_VALUE.S_AXI_ACLK.FREQ_HZ PARAM_VALUE.C_NUM_MONITOR_SLOTS PARAM_VALUE.C_SLOT_0_AXI_PROTOCOL PARAM_VALUE.C_SLOT_1_AXI_PROTOCOL PARAM_VALUE.C_SLOT_2_AXI_PROTOCOL PARAM_VALUE.C_SLOT_3_AXI_PROTOCOL PARAM_VALUE.C_SLOT_4_AXI_PROTOCOL PARAM_VALUE.C_SLOT_5_AXI_PROTOCOL PARAM_VALUE.C_SLOT_6_AXI_PROTOCOL PARAM_VALUE.C_SLOT_7_AXI_PROTOCOL PARAM_VALUE.C_ENABLE_EVENT_LOG PARAM_VALUE.C_ENABLE_TRACE PARAM_VALUE.C_LOG_DATA_OFFLD } {
set a [ get_property value ${PARAM_VALUE.C_NUM_MONITOR_SLOTS} ]
set freq_list ""
        for {set i 0} {$i<$a} {incr i} {
		 
	if {[ get_property value [set PARAM_VALUE.C_SLOT_${i}_AXI_PROTOCOL]] == "AXI4S"} {
		lappend freq_list [ get_property value [set BUSIFPARAM_VALUE.SLOT${i}_AXIS_CLK.FREQ_HZ]]
	} else {
		lappend freq_list [ get_property value [set BUSIFPARAM_VALUE.slot${i}_axi_clk.FREQ_HZ]]
	}

}
		lappend freq_list [ get_property value ${BUSIFPARAM_VALUE.S_AXI_ACLK.FREQ_HZ}]
if { [get_property value ${PARAM_VALUE.C_ENABLE_EVENT_LOG}] == 1 || [get_property value ${PARAM_VALUE.C_ENABLE_TRACE}] ==1 && [get_property value ${PARAM_VALUE.C_LOG_DATA_OFFLD}] == 0} {
		lappend freq_list [ get_property value ${BUSIFPARAM_VALUE.M_AXIS_ACLK.FREQ_HZ}]

}
if { [get_property value ${PARAM_VALUE.C_ENABLE_EVENT_LOG}] == 1 || [get_property value ${PARAM_VALUE.C_ENABLE_TRACE}] ==1 && [get_property value ${PARAM_VALUE.C_LOG_DATA_OFFLD}] == 1} {
		lappend freq_list [ get_property value ${BUSIFPARAM_VALUE.S_AXI_OFFLD_ACLK.FREQ_HZ}]

}
set sort_freq [lsort -real -decreasing $freq_list ]
if { [lindex $sort_freq 0] > [ get_property value ${BUSIFPARAM_VALUE.CORE_ACLK.FREQ_HZ}] } {
       set_property errmsg "Core clock should be higher than all the available clocks"  ${BUSIFPARAM_VALUE.CORE_ACLK.FREQ_HZ}  
   return false

} else {
    # puts "Maximum clock frequency  [lindex $sort_freq 0] which is  [ get_property value ${BUSIFPARAM_VALUE.slot0_axi_clk.FREQ_HZ}] and core clock frequency [ get_property value ${BUSIFPARAM_VALUE.CORE_ACLK.FREQ_HZ}] \n" 
     return true

}
     #puts "Maximum clock frequency  [lindex $sort_freq 0] which is  [ get_property value ${BUSIFPARAM_VALUE.slot0_axi_clk.FREQ_HZ}] and core clock frequency [ get_property value ${BUSIFPARAM_VALUE.CORE_ACLK.FREQ_HZ} andddddd sorted $sort_freq] \n" 
