...
set_property -dict [list CONFIG.PROTOCOL {AXI4} CONFIG.C_AXI_PROTOCOL {0} CONFIG.C_MEM_ADDR_WIDTH {36} CONFIG.C_FIFO_DEPTH_B {32} CONFIG.C_FIFO_DEPTH_R {512} CONFIG.C_AXI_ID_WIDTH {6} CONFIG.C_AXI_ADDR_WIDTH {40} CONFIG.C_AXI_DATA_WIDTH {64}] [get_bd_cells axi_delay_2]
set_property -dict [list CONFIG.PROTOCOL {AXI4} CONFIG.C_AXI_PROTOCOL {0} CONFIG.C_MEM_ADDR_WIDTH {36} CONFIG.C_FIFO_DEPTH_B {32} CONFIG.C_FIFO_DEPTH_R {512} CONFIG.C_AXI_ID_WIDTH {6} CONFIG.C_AXI_ADDR_WIDTH {40} CONFIG.C_AXI_DATA_WIDTH {64}] [get_bd_cells axi_delay_3]
...
set_property -dict [list CONFIG.PROTOCOL {AXI4} CONFIG.C_AXI_PROTOCOL {0} CONFIG.C_MAP_WIDTH {20} CONFIG.C_MAP_IN {00000000000000000000} CONFIG.C_MAP_OUT {00001000000000000000} CONFIG.C_AXI_ID_WIDTH {4} CONFIG.C_AXI_ADDR_WIDTH {40} CONFIG.C_AXI_DATA_WIDTH {64}] [get_bd_cells axi_shim_2]
set axi_shim_3 [ create_bd_cell -type ip -vlnv llnl.gov:user:axi_shim:1.4 axi_shim_3 ]
set_property -dict [list CONFIG.PROTOCOL {AXI4} CONFIG.C_AXI_PROTOCOL {0} CONFIG.C_MAP_WIDTH {8} CONFIG.C_MAP_IN {00000000} CONFIG.C_MAP_OUT {00011000} CONFIG.C_AXI_ID_WIDTH {4} CONFIG.C_AXI_ADDR_WIDTH {40} CONFIG.C_AXI_DATA_WIDTH {64}] [get_bd_cells axi_shim_3]
