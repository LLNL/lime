...
proc cr_bd_main {parentCell} {
	...
	set trc_addr_width {29}
	set trc_data_width {128}
	...
	set_property -dict [list \
		...
		CONFIG.PSU__CRL_APB__PL0_REF_CTRL__FREQMHZ {187.5} \
		CONFIG.PSU__FPGA_PL1_ENABLE {1} \
		CONFIG.PSU__CRL_APB__PL1_REF_CTRL__SRCSEL {IOPLL} \
		CONFIG.PSU__CRL_APB__PL1_REF_CTRL__FREQMHZ {187.5} \
	...
	set_property CONFIG.FREQ_HZ {300000000} $sysclk
