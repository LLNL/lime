...
set_property -dict [list CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR0 {5}] [get_bd_cells zynq_ultra_ps_e_0]
...
set_property -dict [list CONFIG.C_AXI_PROTOCOL {0} CONFIG.C_MAP_WIDTH {20} CONFIG.C_MAP_IN {00000100000000000000} CONFIG.C_MAP_OUT {00001000000000000000} CONFIG.C_AXI_ID_WIDTH {16} CONFIG.C_AXI_ADDR_WIDTH {40} CONFIG.C_AXI_DATA_WIDTH {128}] [get_bd_cells axi_shim_0]
set axi_shim_1 [ create_bd_cell -type ip -vlnv llnl.gov:user:axi_shim:1.4 axi_shim_1 ]
set_property -dict [list CONFIG.C_AXI_PROTOCOL {0} CONFIG.C_MAP_WIDTH {8} CONFIG.C_MAP_IN {00000100} CONFIG.C_MAP_OUT {00011000} CONFIG.C_AXI_ID_WIDTH {16} CONFIG.C_AXI_ADDR_WIDTH {40} CONFIG.C_AXI_DATA_WIDTH {128}] [get_bd_cells axi_shim_1]
