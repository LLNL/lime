...
#define MAIN(_argc, _argv) \
static _sub_main(_argc, _argv); \
...
int static _sub_main(_argc, _argv)
#elif defined(SYSTEMC)
#define MAIN(_argc, _argv) _sub_main(_argc, _argv)
#else // not _MMU_SETUP, _GET_ARGS, _MONITOR_INIT, _FINI_BUG, SYSTEMC
#define MAIN(_argc, _argv) main(_argc, _argv)
#endif // end

#endif /* end SYSINIT_H_ */
